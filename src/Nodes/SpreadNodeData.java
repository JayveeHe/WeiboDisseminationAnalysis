...
public class SpreadNodeData implements Comparable<SpreadNodeData> {
     ...
     *
     * @param level             该节点的转发级数
     * @param name              该节点的用户名
     * @param parent_name       该节点的母节点用户名
     * @param text              该节点的用户所发的内容
     * @param wid               该节点代表的微博的id，此值唯一，应该作为主键
     * @param uid               该节点用户的id，唯一
     * @param post_time         该节点微博发送的时间
     * @param ArrayList<String> repost_link 转发链，最小大小为1
     * @param repost_count      该节点的转发总数
     * @author Jayvee
     */
    public SpreadNodeData(int level, String name, String parent_name,
        ...
        try {
            this.post_time_long = WeiboSpreadUtils.parseTime(post_time);
    ...
    public long getPost_time_long() {
        return post_time_long;
    }
...
//		return (int) (time - oposttime);// 以发送时间升序排序
        return (int)(this.getPost_time_long() - o.getPost_time_long());
    }
     ...
     * @author Jayvee
     */
    public static class AscPostTimeComparator implements
            Comparator<SpreadNodeData> {

        @Override
        public int compare(SpreadNodeData o1, SpreadNodeData o2) {
            // TODO Auto-generated method stub
            return (int) (Long.compare(o1.getPost_time_long(),o2.getPost_time_long()));
        }
